<?php
    ...
    $sql = "SELECT DISTINCT(Publication) FROM book_info";
    ...
    <div class="container">
        <div class="row" style="border-style: double;">
            ...
            <div class="col-sm-4">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <select class="form-select" name="option" style="margin-right: 20px; width:100px;">
                        <?php
        ...
        <?php
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $sql = "SELECT * FROM book_info WHERE Publication = '$option';";
                $result = mysqli_query($db, $sql);
